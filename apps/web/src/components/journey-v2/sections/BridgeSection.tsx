    ...
    <JourneySection id="bridge" background="transparent" className="flex items-center justify-center py-12 md:py-20">
      <div ref={contentRef} className="relative z-10 w-full max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <motion.div
            className="inline-flex items-center gap-3 px-5 py-3 bg-white/5 border border-white/10"
            initial={{ opacity: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Bitcoin Side */}
          <motion.div
            className={`p-6 bg-gradient-to-b from-[#050505] to-black/30 border transition-all duration-500 ${
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-[#D4AF37]/70">Created 2009</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <motion.div
                  className="mt-2 p-2  bg-[#D4AF37]/10 text-xs space-y-1"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: connectionStep >= 1 ? 1 : 0 }}
                >
                  <div>
                    <span className="text-[#D4AF37] font-bold">43</span>
                    <span className="text-[#D4AF37]/70"> = CFB constant</span>
                  </div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs text-[#D4AF37] hover:text-orange-300 transition-colors mt-2"
                >
              ...
              >
                ...
                <div className="text-sm text-white/40 space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-[#D4AF37]">Jan 3, 2009</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Block #283:</span>
                    <span className="text-[#D4AF37]">Jan 12, 2009</span>
                  </div>
                  <div className="flex justify-between">
                    <span>1CFB Address:</span>
                    <span className="text-[#D4AF37]">Jan 13, 2009</span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <motion.div
            className={`p-6 bg-gradient-to-b from-[#050505] to-black/30 border transition-all duration-500 ${
              connectionStep >= 2 ? 'border-[#D4AF37]/40' : 'border-purple-900/30'
            }`}
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: isInView ? 1 : 0, x: isInView ? 0 : 30 }}
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-[#D4AF37]/70">Launched 2024</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-[#D4AF37]/80">What is Qubic?</span>
                </div>
        ...
        <AnimatePresence>
          {showBridge && (
            <motion.div
              className="p-6 md:p-8 rounded-2xl bg-gradient-to-r from-[#050505]/80 via-[#050505] to-[#050505]/80 border border-white/10 mb-8 relative overflow-hidden"
            ...
            >
              {/* Background glow */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-[#D4AF37]/5 via-[#D4AF37]/10 to-[#D4AF37]/5"
              ...
              <div className="relative">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
                  {/* Bitcoin Block #283 */}
                  <motion.div
                    className="text-center p-4 bg-black/30"
                  ...
                  <div className="flex items-center gap-2">
                    <motion.div
                      className="hidden md:block w-12 h-0.5 bg-gradient-to-r from-[#D4AF37] to-[#D4AF37]"
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
                ...
                >
                  <p className="text-sm text-white/40">
                    A specific memory position in <span className="text-[#D4AF37]">Qubic</span>{' '}
                    mathematically encodes a reference to <span className="text-[#D4AF37]">Bitcoin</span> Block #283.
                  </p>
                  <p className="text-xs text-white/50 mt-2">
                    Using primes <span className="text-white/50">283, 47</span> and the physics constant <span className="text-[#D4AF37]/70">137</span>
                  </p>
                </motion.div>
              </div>
            </motion.div>
        ...
        >
          <div className="p-5 bg-white/5 border border-white/10">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              ...
              <span className="text-[#D4AF37]"> astronomically low</span>.
          ...
          <div className="p-5 bg-white/5 border border-white/10">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              ...
              <span className="text-[#D4AF37]"> wouldn't launch until 2024</span>.
