...
// Hyperspeed configuration with Bitcoin orange & Qubic Tiffany blue
// Optimized for performance - reduced light elements
const HYPERSPEED_CONFIG = {
  ...
  speedUp: 2,
  carLightsFade: 0.4,
  totalSideLightSticks: 30, // Reduced from 50 for better performance
  lightPairsPerRoadWay: 30, // Reduced from 50 for better performance
...
export function VoidSection() {
  ...
  // Show everything immediately on mount - no delays
  useEffect(() => {
    setMounted(true)
  ...
  return (
    <JourneySection id="void" background="black" disableLiquidEther>
      {/* Permanent black background - prevents white flash */}
      <div className="absolute inset-0 bg-black" />

      {/* Hyperspeed Effect - loads immediately */}
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pb-32">
        <div className="text-center max-w-4xl mx-auto -mt-16">
          ...
          >
            ...
            <motion.div
              className="w-20 h-[2px] bg-gradient-to-r from-orange-500 via-white/30 to-cyan-400"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
          ...
          {/* Story intro - glassmorphism card */}
          <AnimatePresence>
            {showSubtitle && (
              <motion.div
              ...
              >
                <div className="bg-black/50 backdrop-blur-md rounded-xl px-6 py-5 border border-white/10">
                  ...
                  <motion.p
                    className="text-sm text-cyan-400 italic mt-3 font-medium"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
      ...
      {/* Bottom gradient fade - fades to transparent for seamless LiquidEther transition */}
