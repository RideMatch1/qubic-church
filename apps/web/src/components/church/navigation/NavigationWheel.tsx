    ...
    <div className="relative w-full h-full">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {SEGMENTS.map((seg, i) => {
          ...
          const iconSize = seg.isCfb ? '1.8rem' : seg.isPrimary ? '1.6rem' : '1.4rem'
          const nameSize = seg.isCfb ? '0.56rem' : '0.5rem'
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Chalk annotations — desktop only */}
          <m.div
          ...
          >
            <Image
              src="/images/chalk-wheel.png"
              alt=""
              fill
              sizes="(max-width: 768px) 0px, 680px"
              className="object-contain"
              style={{ filter: 'brightness(1.8) contrast(1.3)', transform: 'scale(1.05)' }}
              aria-hidden
              draggable={false}
              priority
            />
          ...
          >
            ...
            <div
              ...
              style={{ width: 'min(680px, 58vh)', height: 'min(680px, 58vh)' }}
            >
