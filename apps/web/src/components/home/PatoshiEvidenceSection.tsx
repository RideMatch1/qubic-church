...
function EvidenceCard({ icon, title, stat, statLabel, children, delay }: EvidenceCardProps) {
  ...
  return (
    <motion.div
      ref={ref}
      className="p-5 bg-gradient-to-b from-[#050505] to-[#050505]/80 border border-white/[0.04] relative overflow-hidden"
      initial={{ opacity: 0, y: 30 }}
      animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
      transition={{ duration: 0.5, delay }}
    >
      {/* Classified stamp effect */}
      <div className="absolute top-2 right-2 text-[8px] font-mono text-[#D4AF37]/30 uppercase tracking-wider">
        Research Finding
      </div>

      <div className="flex items-start gap-3 mb-3">
        <div className="p-2 bg-[#D4AF37]/20 text-[#D4AF37] shrink-0">
          {icon}
        </div>
        <div>
          ...
          {stat && (
            <div className="mt-1">
              <span className="text-2xl font-mono font-bold text-[#D4AF37]">{stat}</span>
    ...
    <section ref={sectionRef} className="py-20 px-4 bg-gradient-to-b from-[#050505]/60 to-transparent">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-xs text-[#D4AF37]/70 mt-2 italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <p>
              ...
              22,000 blocks. These coins have <strong className="text-[#D4AF37]">never been moved</strong>.
            </p>
            <p>
          ...
          >
            ...
            <p>
              ...
              and the formula <span className="font-mono text-[#D4AF37]">625,284 = 283 x 47^2 + 137</span>.
            </p>
          </EvidenceCard>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
              <div className="p-2  bg-[#D4AF37]/10 border border-[#D4AF37]/20 text-center">
                <div className="text-xs text-[#D4AF37]">Block #9</div>
                <div className="font-mono font-bold text-[#D4AF37]">0xCA</div>
                <div className="text-[10px] text-muted-foreground">Verified Match</div>
              </div>
              <div className="p-2  bg-[#D4AF37]/10 border border-[#D4AF37]/20 text-center">
                <div className="text-xs text-[#D4AF37]">Block #16065</div>
                <div className="font-mono font-bold text-[#D4AF37]">0x4A</div>
                <div className="text-[10px] text-muted-foreground">Verified Match</div>
              </div>
            </div>
          </EvidenceCard>
        ...
        {/* Disclaimer */}
        <motion.div
          className="mt-8 p-4 bg-card/50 border border-border text-center"
          initial={{ opacity: 0 }}
