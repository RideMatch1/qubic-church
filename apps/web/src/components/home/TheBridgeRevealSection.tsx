      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <button
            ...
            className="px-6 py-2 bg-muted hover:bg-muted/80 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-6 py-2 bg-primary text-primary-foreground hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-2"
          >
            Next
              ...
              content={
                <div className="space-y-4 text-sm text-muted-foreground">
                  ...
                  <ul className="space-y-2 ml-4">
                    <li><strong className="text-[#D4AF37]">283</strong>: Bitcoin block number from January 2009</li>
                    <li><strong className="text-[#D4AF37]">47</strong>: Prime number appearing 47 times in Qubic core</li>
                    <li><strong className="text-[#D4AF37]">137</strong>: Fine-structure constant from physics</li>
                    <li><strong className="text-primary">625,284</strong>: Qubic's main network address</li>
                  </ul>
                  <div className="p-4 bg-verified-bg border border-verified text-verified">
            ...
            <DiscoveryAccordion
              ...
              preview={
                <div className="flex items-center justify-center gap-4 py-2">
                  ...
                  <motion.div
                    className="w-24 h-1 bg-gradient-to-r from-[#D4AF37] to-[#D4AF37] rounded-full"
              ...
              content={
                <div className="space-y-4 text-sm text-muted-foreground">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 bg-verified-bg border border-verified text-center">
            ...
            <DiscoveryAccordion
              ...
              content={
                <div className="space-y-4 text-sm text-muted-foreground">
                  ...
                  <div className="p-4 bg-warning-bg border border-warning">
...
function BitcoinGenesisStep({ isInView }: { isInView: boolean }) {
  return (
    ...
    >
      <div className="p-6 bg-gradient-to-b from-[#050505] to-[#050505]/80 border border-white/[0.04]">
        ...
        <div className="space-y-4">
          <DataCard
            icon={<Binary className="h-4 w-4 text-[#D4AF37]" />}
          ...
          <DataCard
            icon={<Hash className="h-4 w-4 text-[#D4AF37]" />}
      ...
      <div className="p-6 bg-muted/30 border border-border flex flex-col justify-center">
        <h4 className="text-lg font-semibold mb-4">Why Block #283?</h4>
        <ul className="space-y-3 text-sm text-muted-foreground">
          <li className="flex items-start gap-2">
            <Target className="h-4 w-4 text-[#D4AF37] mt-1 flex-shrink-0" />
            One of the first 300 blocks ever created
          </li>
          <li className="flex items-start gap-2">
            <Zap className="h-4 w-4 text-[#D4AF37] mt-1 flex-shrink-0" />
            Mined by Satoshi Nakamoto himself
          </li>
          <li className="flex items-start gap-2">
            <Lock className="h-4 w-4 text-[#D4AF37] mt-1 flex-shrink-0" />
            Contains 50 BTC (~$2.5M) never moved
          </li>
          <li className="flex items-start gap-2">
            <Calculator className="h-4 w-4 text-[#D4AF37] mt-1 flex-shrink-0" />
...
function FormulaStep({ isInView }: { isInView: boolean }) {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, x: 20 }}
      transition={{ duration: 0.4 }}
      className="p-8 bg-gradient-to-r from-[#050505]/80 via-[#050505] to-[#050505]/80 border border-border"
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
        <div className="text-center">
          ...
          <div className="text-3xl font-mono font-bold text-[#D4AF37]">#283</div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        <div className="p-3 bg-[#D4AF37]/10 border border-[#D4AF37]/20">
          <div className="text-[#D4AF37] font-bold text-2xl">283</div>
          <div className="text-xs text-muted-foreground">Prime Block #</div>
        </div>
        <div className="p-3 bg-[#D4AF37]/10 border border-[#D4AF37]/20">
          <div className="text-[#D4AF37] font-bold text-2xl">47²</div>
          <div className="text-xs text-muted-foreground">= 2,209</div>
        </div>
        <div className="p-3 bg-[#D4AF37]/10 border border-[#D4AF37]/20">
          <div className="text-[#D4AF37] font-bold text-2xl">137</div>
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <DataCard
          ...
          content={
            <div className="text-center">
              <div className="text-[#D4AF37] font-bold text-2xl">Row 21, Col 4</div>
        ...
        <DataCard
          icon={<Calculator className="h-4 w-4 text-[#D4AF37]" />}
          title="Network Stats"
          content={
            <div className="grid grid-cols-2 gap-2 text-center">
              <div>
                <div className="text-[#D4AF37] font-bold">676</div>
                <div className="text-xs text-muted-foreground">Computors</div>
              </div>
              <div>
                <div className="text-[#D4AF37] font-bold">50K+</div>
  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <Lock className="h-12 w-12 text-[#D4AF37] mx-auto mb-3" />
      ...
      <div className="mt-6 p-4 bg-[#D4AF37]/10 border border-[#D4AF37]/20">
        <p className="text-sm text-[#D4AF37]/90 text-center">
          A cryptographic safe that opens automatically on this date.
          <br />
          <strong className="text-[#D4AF37]">56 days remaining.</strong>
        </p>
      </div>
    </motion.div>
  )
...
function DiscoveryAccordion({
  ...
  return (
    <div className={`rounded-xl border bg-card/50 overflow-hidden transition-all ${colorClasses[color]}`}>
      ...
      >
        <div className={`p-2 ${iconBg[color]}`}>{icon}</div>
