...
import { CFBHero, TimelineSection } from '@/components/cfb'
...
export default async function CFBTimelinePage(props: {
          ...
          <div className="container">
            <div className="flex flex-col items-center text-center">
              <p className="text-sm text-muted-foreground">
                CFB Forensics - Biographical Timeline
              </p>
              <p className="mt-2 font-mono text-xs text-muted-foreground/80">
                1979 - 2026 | 47 Key Events Documented
              </p>
            </div>
          </div>
        </footer>
