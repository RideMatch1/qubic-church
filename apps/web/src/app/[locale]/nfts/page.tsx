          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative w-full md:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-purple-500/50 transition-colors"
              />
            </div>
            ...
            {filteredNFTs.map((nft, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative rounded-xl overflow-hidden border ${rarityConfig.borderColor} ${rarityConfig.bgColor} hover:scale-[1.02] transition-transform cursor-pointer`}
                ...
                >
                  ...
                  <div className={`relative ${viewMode === 'grid' ? 'aspect-square' : 'aspect-square'}`}>
                    ...
                    {/* Rarity Badge */}
                    <div className={`absolute top-2 right-2 p-1.5 rounded-lg ${rarityConfig.bgColor} border ${rarityConfig.borderColor}`}>
        ...
        {selectedNFT && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl bg-gradient-to-b from-white/10 to-white/5 border border-white/20 rounded-2xl overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button */}
              <button
                onClick={() => setSelectedNFT(null)}
                className="absolute top-4 right-4 z-10 p-2 rounded-full bg-black/50 text-white/60 hover:text-white transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-6">
                  ...
                  <p className="text-lg text-purple-400 mb-4">{selectedNFT.title}</p>
                  ...
                  {selectedNFT.researchConnection && (
                    <div className="p-4 rounded-xl bg-purple-500/10 border border-purple-500/20 mb-6">
                      <p className="text-xs text-purple-400 uppercase tracking-wider mb-1">Research Connection</p>
                  ...
                  <div className="p-4 rounded-xl bg-white/5 border border-white/10 mb-6">
                    <p className="text-xs text-white/40 uppercase tracking-wider mb-2">NFT Role</p>
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-semibold hover:from-purple-400 hover:to-cyan-400 transition-all"
                  >
                    View on QubicBay
